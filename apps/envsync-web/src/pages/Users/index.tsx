        ...
        secondaryNav={
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            <TabsList className="h-auto bg-transparent p-0">
              <TabsTrigger value="members" className="rounded-xl text-muted-foreground data-[state=active]:bg-emerald-500/18 data-[state=active]:text-foreground">
                <span data-testid="users-tab-members">Members</span>
              </TabsTrigger>
              <TabsTrigger value="invitations" className="rounded-xl text-muted-foreground data-[state=active]:bg-emerald-500/18 data-[state=active]:text-foreground">
