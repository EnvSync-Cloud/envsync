    ...
    return (
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="max-w-4xl bg-card border-border">
          <DialogHeader>
            <DialogTitle className="text-foreground">Manage Invitations</DialogTitle>
          </DialogHeader>
          ...
          <div className="space-y-4">
            {invitations.length === 0 ? (
              <div className="text-center py-8">
                <Mail className="mx-auto h-12 w-12 text-tertiary mb-4" />
                <h3 className="text-lg font-medium text-foreground mb-2">No invitations</h3>
                <p className="text-muted-foreground">There are no pending invitations at the moment.</p>
              </div>
            ) : (
                  ...
                  <TableBody>
                    {invitations.map((invitation) => (
                      <TableRow key={invitation.id} className="border-border hover:bg-muted/50">
                        ...
                        <TableCell className="text-muted-foreground">{invitation.roleName}</TableCell>
                        <TableCell>{getStatusBadge(invitation)}</TableCell>
                        <TableCell className="text-muted-foreground">{invitation.createdAt}</TableCell>
                        <TableCell>
