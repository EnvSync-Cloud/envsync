...
export default function OrgOidc() {
  ...
  return (
    <EnterprisePageFrame
      title="Workload OIDC"
      description="Trust CI and cluster identities (GitHub Actions, GitLab, Kubernetes) without long-lived service tokens. Human SAML login stays on SSO."
    ...
    >
      ...
      <EnterpriseDeleteDialog
        ...
        description={`Machines using ${deleteTarget ? providerLabel(deleteTarget.provider_type) : "this provider"} will no longer authenticate.`}
